    ...
    <div class="w3-row-padding">
      ...
      <div class="w3-twothird">
        <div class="w3-container w3-card w3-white w3-margin-bottom">
          ...
          <?php for ($i = 0; $i < count($expiarence); $i++): 
            $Name = $expiarence[$i]['name'];
            $star_date = $expiarence[$i]['star_date'];
            $end_date = $expiarence[$i]['end_date'];
            $description = $expiarence[$i]['description'];
            ?>
            <div class="w3-container">
            <h5 class="w3-opacity"><b><?php echo $Name; ?> </b></h5>
            <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i><?php echo $star_date; ?> - <span
                class="w3-tag w3-teal w3-round"><?php echo $end_date; ?></span></h6>
